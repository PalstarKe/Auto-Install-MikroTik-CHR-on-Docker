...
- [Readme ID](https://github.com/PalstarKe/Auto-Install-MikroTik-CHR-on-Docker/blob/main/README.md)
...
### RouterOS 7
```
bash <(wget -qO- https://raw.githubusercontent.com/PalstarKe/Auto-Install-MikroTik-CHR-on-Docker/main/RoS7/v7.sh)
```
...
- Pull
```
docker pull PalstarKe/ros7
```
- Run
```
sudo docker run --name ros7 --restart unless-stopped -p 8291:8291 -p 8728:8728 -p 8729:8729 -p 2222:22 -p 8080:80 -p 443:443 -p 2121:21 PalstarKe/ros7:latest
```
