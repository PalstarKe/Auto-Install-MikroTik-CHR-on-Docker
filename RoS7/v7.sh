...
wget https://github.com/elseif/MikroTikPatch/releases/download/7.16.2/chr-7.16.2.qcow2.zip

# Ekstrak Image
unzip chr-7.16.2.qcow2.zip
...
# Copy the CHR image
COPY chr-7.16.2.qcow2 /chr-7.16.2.qcow2
...
echo "MikroTik CHR has been successfully installed and running in Docker with the name mikrotik-chr-6.
You can access it using the forwarded ports."